...
% PDF-Merkmale
\usepackage[
  pdftitle={Memory-based online learning of simple object manipulation},            % Titel des PDF Dokuments.
  pdfauthor={Jan Pöppel},                 % Autor des PDF Dokuments.
  pdfsubject={Memory-based online learning of simple object manipulation},          % Thema des PDF Dokuments.
...
\usepackage[numbers,sort]{natbib}  % Linguistik und Naturwissenschaften
