...
\begin{titlepage}
  ...
  \begin{center}
    ...
    % Titel der Arbeit
    {\fontspec[Color=101010, Scale=2.5]{FagoNoLf-Bold} Memory-based online learning of simple object manipulation} \\
    \vspace{10pt} % Vertikaler Abstand von 10pt
    ...
    {\fontspec[Color=101010, Scale=1.2]{FagoNo}November 2015}
