...
The goal of this thesis is to provide possible models that learn simple interactions between physical objects. In the scope of this thesis, these interactions are limited to pushing contacts between objects in two dimensions. An overview about the situation can be seen in figure \ref{fig:overview}. %TODO pushing contacts not really correct, sounds like I only deal with the moments where they are already connected
