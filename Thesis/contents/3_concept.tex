...
\subsection{Planning \label{sec:pairPlanning}}
...
\subsection{Prediction \label{sec:gatePrediction}}
...
%The local forward model predicts the next object state with the relative features.
...
%TODO Alternative depending on where I talk about differences
%This allows the local models to be independent of the actual object states. The concept assumes, that an interaction between two objects behaves the same in different situations as long as their relative interaction features are the same.  %TODO might be doubled with the realization subsection, fix!
